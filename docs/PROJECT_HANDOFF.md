...
> 更新时间：2026-09-20；当前应用生产提交：`693b534`（PR #41）。
...
- 代码：2026-09-20 只读核对 `/opt/teacher-dashboard/current` 指向 `/opt/teacher-dashboard/releases/693b534`；上一版本 `4f66a22` 及其他历史发布目录仍保留，回滚前须重新核对目标与数据兼容性。
...
| v3.6 | 2026-09-20 | 当前 | 核对生产指向 693b534，补记 PR #35–#41 的 PDF/移动端发布历程和手机 A→B→A 待验收状态；数据目录保持 -r2。 |
