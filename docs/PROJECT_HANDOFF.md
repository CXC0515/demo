...
> 更新时间：2026-09-10；当前 Git 稳定基线：`origin/main@23b63b6`（PR #18），功能基线为 `54ff5dc`（PR #17）。
...
- GitHub `origin/main` 是唯一稳定基线；当前为 `23b63b6`，已包含 PR #17 的功能修改和 PR #18 的部署交接更新。
...
| v2.1 | 2026-09-10 | 当前 | 校正 Git 基线为 PR #18；记录公网 530 与 Tunnel 出口异常证据、已购服务器的未核实状态，以及下一会话的服务器迁移调查入口。 |
