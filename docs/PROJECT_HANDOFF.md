...
> 更新时间：2026-09-17；当前应用生产提交：`80787d5`（PR #32）。
...
- 代码：`/opt/teacher-dashboard/current` 指向 `/opt/teacher-dashboard/releases/80787d5`；保留 `d0dead8`、`b13be36` 与 `9837298` 供回滚。
...
- GitHub `origin/main` 是唯一稳定基线，生产应用当前运行 `80787d5`（PR #32）。
...
| v3.4 | 2026-09-17 | 当前 | PR #32 手机控件第三轮收敛发布为 80787d5；数据目录保持 -r2。 |
