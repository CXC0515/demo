...
> 更新时间：2026-09-17；当前应用生产提交：`fd0f8f7`（PR #34）。
...
- 代码：`/opt/teacher-dashboard/current` 指向 `/opt/teacher-dashboard/releases/fd0f8f7`；保留 `80787d5`、`d0dead8`、`b13be36` 与 `9837298` 供回滚。
...
- GitHub `origin/main` 是唯一稳定基线，生产应用当前运行 `fd0f8f7`（PR #34）。
...
| v3.5 | 2026-09-17 | 当前 | PR #34 PDF.js 阅读器、上传前首页预览和移动选择器修复发布为 fd0f8f7；数据目录保持 -r2。 |
