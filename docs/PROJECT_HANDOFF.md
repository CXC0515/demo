...
> 更新时间：2026-09-12；当前 Git 稳定基线：`origin/main@b1583be`（PR #20）。
...
- GitHub `origin/main` 是唯一稳定基线；2026-09-12 只读核对为 `b1583be`，已包含 PR #20 的 AI 批改材料显式解析控制、响应式反馈、拆题错误分类和 COS 后续边界记录。
...
| v2.3 | 2026-09-12 | 当前 | 校正稳定 Git 基线为 PR #20，记录 AI 批改材料解析控制和 COS 后续边界已合并部署。 |
