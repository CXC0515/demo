...
> 更新时间：2026-09-16；当前应用生产提交：`origin/main@03b3a0d`。
...
- 代码：`/opt/teacher-dashboard/current` 指向 `/opt/teacher-dashboard/releases/03b3a0d`。
...
- GitHub `origin/main` 是唯一稳定基线，生产应用当前运行 `03b3a0d`（PR #24）。
...
| v3.0 | 2026-09-16 | 当前 | 记录硅谷生产切换、`td.unreached.top`、权威数据 `-r2`、HTTPS、自动备份及最小公网验收。 |
