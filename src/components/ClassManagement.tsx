...
import { 
  ...
  UserCheck, Shield, BookOpen, X, ArrowRight 
} from 'lucide-react';
          ...
          {selectedClass ? (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-3 p-4 bg-slate-50 dark:bg-zinc-800/40 rounded-2xl border border-slate-100 dark:border-zinc-800 text-xs text-slate-600 dark:text-slate-300">
                ...
                <div className="flex justify-between">
                  <span className="text-slate-400">语文教材版本：</span>
              ...
              <div className="space-y-2">
                <span className="text-xs font-bold text-slate-400 uppercase tracking-wider block">班级语文课代表</span>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-3xl max-w-lg w-full p-6 space-y-5 shadow-2xl animate-fade-in border border-slate-100 dark:border-zinc-800 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-400 uppercase tracking-wider block">语文教材版本</label>
                  <input
                    type="text"
              ...
              {/* Set Representatives Multi-select list */}
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-400 uppercase tracking-wider block">指派语文课代表</label>
                <div className="p-3 bg-slate-50 dark:bg-zinc-800/50 rounded-2xl border border-slate-200 dark:border-zinc-700 max-h-32 overflow-y-auto grid grid-cols-2 gap-2">
                  {students
                    .filter(s => showAddModal ? true : s.classId === selectedClassId)
                    .map(student => {
                      ...
                      return (
                        <div 
                          ...
                          className={`p-2 rounded-lg border text-xs font-medium cursor-pointer flex items-center gap-1.5 transition-all ${
                            isRep 
                              ? 'bg-emerald-600/10 border-emerald-500 text-emerald-800 dark:text-emerald-400' 
                              : 'bg-white dark:bg-zinc-800 border-slate-200 dark:border-zinc-700 text-slate-600 dark:text-slate-300'
                          }`}
                        >
                          <input 
                            type="checkbox" 
